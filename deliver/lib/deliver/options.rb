    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :screenshots_path,
                                     ...
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :trailers_path,
                                     description: "Path to the folder containing the video trailers and preview pictures",
                                     optional: true),
        ...
        FastlaneCore::ConfigItem.new(key: :skip_screenshots,
                                     ...
                                     is_string: false,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :skip_trailers,
                                     description: "Don't upload trailers and their preview images",
                                     is_string: false,
                                     default_value: false),
